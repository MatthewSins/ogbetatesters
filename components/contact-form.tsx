...
export function ContactForm() {
  ...
  return (
    <form action="https://formsubmit.co/ogbetatesters@proton.me"method="POST" className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input id="first-name" placeholder="John" required className="bg-black/50 border-white/10 text-white" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="last-name" className="text-white">
            Last name
          </Label>
          <Input id="last-name" placeholder="Doe" required className="bg-black/50 border-white/10 text-white" />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input id="company" placeholder="Your Company" className="bg-black/50 border-white/10 text-white" />
      </div>
